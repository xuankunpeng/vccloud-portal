...
public class Conferencecall2DAOImpl extends SqlMapClientDaoSupport implements Conferencecall2DAO {
	...
	public List<Conferencecall2> searchConferenceCall2s(String tenantName,
		...
		List<Conferencecall2> resultList = getSqlMapClientTemplate()
	...
	public List<Conferencecall2> searchConferenceCall2s4Cdr(String tenantName,
			String callerID, Date startTime, Date endTime) {
		Map params = new HashMap();
		params.put("tenantName", tenantName);
		...
		params.put("endTime", endTime);
		List<Conferencecall2> resultList = getSqlMapClientTemplate()
				.queryForList("ConferenceCall2.searchConferenceCall2s4Cdr",
						params);
		return resultList;
	}

	public int countConferenceCall2s4Report(String tenantName, Date startTime,
			Date endTime) {
		Map params = new HashMap();
		params.put("tenantName", tenantName);
		params.put("startTime", startTime);
		params.put("endTime", endTime);
		Integer count = (Integer) getSqlMapClientTemplate().queryForObject(
				"ConferenceCall2.countConferenceCall2s4Report", params);
		return count.intValue();
	}
}